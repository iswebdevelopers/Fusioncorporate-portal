...
<?php if(!empty($settings)): ?>
	...
	<?php if(!empty($carton)): ?>
		...
		<?php $__currentLoopData = $carton['carton_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>  $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 3); ?>^FDPack Item:<?php echo e($carton['item']); ?>^FS
			^CF0,<?php echo e($font_3); ?>

			^FO<?php echo e($pack_margin_left); ?>,<?php echo e($margin_top); ?>^FD<?php echo e($carton['pack_type']); ?>^FS

			^FX Second.
			^CF0,<?php echo e($font_2); ?>

			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 4); ?>^FH^FDDescription   <?php echo e($carton['description']); ?>^FS
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 4.6); ?>^FDGroup  <?php echo e($carton['group_name']); ?>^FS
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 5.2); ?>^FDDept  <?php echo e($carton['department_name']); ?>^FS
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 5.8); ?>^FDClass  <?php echo e($carton['class_name']); ?>^FS
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 6.4); ?>^FDSubClass  <?php echo e($carton['sub_class_name']); ?>^FS

			^FX Third section with barcode.
			^BY2,2
			^FO<?php echo e($barcodemargin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 7.5); ?>^BCN,<?php echo e($margin_top * 3); ?>,N,N,Y
			^FD<?php echo e($details['pibarcode']); ?>^FS
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 10.7); ?>
			...
			^BY2,2
			^FO<?php echo e($barcodemargin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 11.7); ?>^BCN,<?php echo e($margin_top * 3); ?>,N,N,Y
			^FD<?php echo e($details['barcode']); ?>^FS
			^FO<?php echo e($margin_left + (($count - 1) * $width)); ?>,<?php echo e($margin_top * 15); ?>
